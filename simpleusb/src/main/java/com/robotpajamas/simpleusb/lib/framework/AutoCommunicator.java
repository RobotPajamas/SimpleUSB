...
package com.robotpajamas.simpleusb.lib.framework;
...
public class AutoCommunicator {
    ...
    public com.physicaloid.lib.framework.SerialCommunicator getSerialCommunicator(Context context) {
